    ...
    <div className='h-screen w-screen flex items-center justify-center bg-gray-700' >
        ...
        <div className='h-[50%] w-[45%] rounded-xl bg-white text-black p-6' >
            ...
            <div className='flex flex-col justify-center items-center' >
                ...
                <input type="text" ref={nameRef} placeholder='enter name' className='px-4 my-4 h-10 w-[100%] bg-gray-600 text-white rounded-lg'/>
                ...
                <button className="bg-gray-900 h-10 rounded-xl text-white px-4 hover:bg-gray-600 hover:animate-pulse" onClick={handleSignup} > SignUp </button>
            </div>
